    ...
    <section className="relative min-h-screen text-white overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 py-10 lg:py-20 space-y-8 lg:space-y-16">
        <header className="text-left sm:text-center">
          ...
          <p className="max-w-3xl mx-auto text-[10px] sm:text-lg text-white leading-relaxed">
        ...
        <div className="grid gap-6 lg:gap-10 lg:grid-cols-[1.1fr_0.9fr]">
          ...
          <aside className="rounded-[32px] border border-white/10 bg-white/5 backdrop-blur-sm p-8 sm:p-10 space-y-8 shadow-lg">
            ...
            <a
              ...
              className="inline-flex items-center justify-center w-full rounded-full border border-white/15 px-6 py-3 text-xs font-bold uppercase tracking-[0.08em] text-white hover:bg-white/10"
            >
              Get directions
            </a>
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 p-5 text-sm text-white space-y-3">
