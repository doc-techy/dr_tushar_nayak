          ...
          {featuredServices.map((service) => (
            ...
            >
              ...
              <div className="relative space-y-1 sm:space-y-1.5 md:space-y-1.5 lg:space-y-1.5 p-2 sm:p-3 md:p-3 lg:p-4">
                ...
                <ul className="space-y-0.5 sm:space-y-1 md:space-y-1 lg:space-y-1 hidden md:block">
                  {service.highlights.slice(0, 2).map((highlight) => (
                    <li key={highlight} className="flex items-start gap-1 sm:gap-1.5 md:gap-1.5 lg:gap-1.5 text-[8px] sm:text-[10px] md:text-[10px] lg:text-[11px] text-gray-700">
              ...
              <div className="relative px-2 sm:px-3 md:px-3 lg:px-4 pb-2 sm:pb-3 md:pb-3 lg:pb-4 pt-0">
                <div className="flex items-center justify-between gap-1 pt-1.5 sm:pt-2 lg:pt-2 border-t border-gray-200 sm:border-t-2 lg:border-t group-hover:border-teal-200 transition-colors">
                  ...
                  <div className="flex w-4 h-4 sm:w-5 sm:h-5 md:w-5 md:h-5 lg:w-6 lg:h-6 rounded-full items-center justify-center bg-teal-100 transition-all duration-300 group-hover:bg-brand-teal group-hover:scale-110 flex-shrink-0">
