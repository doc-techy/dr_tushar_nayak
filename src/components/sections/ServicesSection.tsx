  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute inset-0 -z-10">
        <div className="absolute -top-40 left-1/2 w-[400px] sm:w-[550px] lg:w-[680px] h-[400px] sm:h-[550px] lg:h-[680px] -translate-x-1/2 bg-teal-100/40 blur-3xl rounded-full" aria-hidden />
        <div className="absolute bottom-[-10%] right-[10%] w-[300px] sm:w-[420px] lg:w-[520px] h-[300px] sm:h-[420px] lg:h-[520px] bg-teal-100/30 blur-3xl rounded-full" aria-hidden />
        <div className="absolute top-[30%] left-[-10%] w-[250px] sm:w-[340px] lg:w-[420px] h-[250px] sm:h-[340px] lg:h-[420px] bg-brand-navy/10 blur-[180px] rounded-full" aria-hidden />
      </div>
